...
# 自転車種類
BicycleType.create(bicycletype: 'ロードバイク')
BicycleType.create(bicycletype: 'マウンテンバイク')
BicycleType.create(bicycletype: 'クロスバイク')
BicycleType.create(bicycletype: 'シクロクロス')
BicycleType.create(bicycletype: 'ピストバイク')
BicycleType.create(bicycletype: 'ミニベロ')
BicycleType.create(bicycletype: 'シティサイクル(ママチャリ)')
BicycleType.create(bicycletype: '折りたたみ自転車')
BicycleType.create(bicycletype: '電動アシスト自転車')